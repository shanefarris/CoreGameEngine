...
CBuildingOldHouse9_lod2::CBuildingOldHouse9_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse9_lod2.mesh";
...
CBuildingOldHouse9_lod2::~CBuildingOldHouse9_lod2()
{
}

void CBuildingOldHouse9_lod2::SetupMapping()
{
}

void CBuildingOldHouse9_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse9_lod2Factory
CBuildingOldHouse9_lod2Factory::CBuildingOldHouse9_lod2Factory()
{
	BuildingType = "OLDHOUSE9_LOD2";
}
...
Core::CBuilding* CBuildingOldHouse9_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse9_lod2(Name, PhysicsStrategy);
}
