...
CBuildingOldHouse4Socket::CBuildingOldHouse4Socket(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse4Socket.mesh";
	...
	m_BuildingType = "OLDHOUSE4SOCKET";
	// ===================================
...
CBuildingOldHouse4Socket::~CBuildingOldHouse4Socket()
{
}

void CBuildingOldHouse4Socket::SetupMapping()
{
}

void CBuildingOldHouse4Socket::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse4SocketFactory
CBuildingOldHouse4SocketFactory::CBuildingOldHouse4SocketFactory()
{
	BuildingType = "OLDHOUSE4SOCKET";
}
...
Core::CBuilding* CBuildingOldHouse4SocketFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse4Socket(Name, PhysicsStrategy);
}
