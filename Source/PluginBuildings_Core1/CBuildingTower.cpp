...
CBuildingTower::CBuildingTower(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "Tower.mesh";
...
CBuildingTower::~CBuildingTower()
{
}

void CBuildingTower::SetupMapping()
{
}

void CBuildingTower::Update(const f32& elapsedTime)
{
}

// CBuildingTowerFactory
CBuildingTowerFactory::CBuildingTowerFactory()
{
	BuildingType = "TOWER";
}
...
Core::CBuilding* CBuildingTowerFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingTower(Name, PhysicsStrategy);
}
