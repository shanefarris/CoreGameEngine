...
CBuildingRuinedHall::CBuildingRuinedHall(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "RuinedHall.mesh";
...
CBuildingRuinedHall::~CBuildingRuinedHall()
{
}

void CBuildingRuinedHall::SetupMapping()
{
}

void CBuildingRuinedHall::Update(const f32& elapsedTime)
{
}

// CBuildingRuinedHallFactory
CBuildingRuinedHallFactory::CBuildingRuinedHallFactory()
{
	BuildingType = "RUINEDHALL";
}
...
Core::CBuilding* CBuildingRuinedHallFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingRuinedHall(Name, PhysicsStrategy);
}
