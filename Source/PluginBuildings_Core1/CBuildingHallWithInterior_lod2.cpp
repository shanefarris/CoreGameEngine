...
CBuildingHallWithInterior_lod2::CBuildingHallWithInterior_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "HallWithInterior_lod2.mesh";
	...
	m_BuildingType = "HALLWITHINTERIOR_LOD2";
	// ===================================
...
CBuildingHallWithInterior_lod2::~CBuildingHallWithInterior_lod2()
{
}

void CBuildingHallWithInterior_lod2::SetupMapping()
{
}

void CBuildingHallWithInterior_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingHallWithInterior_lod2Factory
CBuildingHallWithInterior_lod2Factory::CBuildingHallWithInterior_lod2Factory()
{
	BuildingType = "HALLWITHINTERIOR_LOD2";
}
...
Core::CBuilding* CBuildingHallWithInterior_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingHallWithInterior_lod2(Name, PhysicsStrategy);
}
