...
CBuildingOldHouse11_lod2::CBuildingOldHouse11_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse11_lod2.mesh";
	...
	m_BuildingType = "OLDHOUSE11_LOD2";
	// ===================================
...
CBuildingOldHouse11_lod2::~CBuildingOldHouse11_lod2()
{
}

void CBuildingOldHouse11_lod2::SetupMapping()
{
}

void CBuildingOldHouse11_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse11_lod2Factory
CBuildingOldHouse11_lod2Factory::CBuildingOldHouse11_lod2Factory()
{
	BuildingType = "OLDHOUSE11_LOD2";
}
...
Core::CBuilding* CBuildingOldHouse11_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse11_lod2(Name, PhysicsStrategy);
}
