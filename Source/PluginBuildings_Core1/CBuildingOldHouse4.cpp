...
CBuildingOldHouse4::CBuildingOldHouse4(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse4.mesh";
...
CBuildingOldHouse4::~CBuildingOldHouse4()
{
}

void CBuildingOldHouse4::SetupMapping()
{
}

void CBuildingOldHouse4::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse4Factory
CBuildingOldHouse4Factory::CBuildingOldHouse4Factory()
{
	BuildingType = "OLDHOUSE4";
}
...
Core::CBuilding* CBuildingOldHouse4Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse4(Name, PhysicsStrategy);
}
