...
CBuildingVillage_house6::CBuildingVillage_house6(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "village_house6.mesh";
...
CBuildingVillage_house6::~CBuildingVillage_house6()
{
}

void CBuildingVillage_house6::SetupMapping()
{
}

void CBuildingVillage_house6::Update(const f32& elapsedTime)
{
}

// CBuildingVillage_house6Factory
CBuildingVillage_house6Factory::CBuildingVillage_house6Factory()
{
	BuildingType = "VILLAGE_HOUSE6";
}
...
Core::CBuilding* CBuildingVillage_house6Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingVillage_house6(Name, PhysicsStrategy);
}
