...
CBuildingElectricTower_lod2::CBuildingElectricTower_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "ElectricTower_lod2.mesh";
	...
	m_BuildingType = "ELECTRICTOWER_LOD2";
	// ===================================
...
CBuildingElectricTower_lod2::~CBuildingElectricTower_lod2()
{
}

void CBuildingElectricTower_lod2::SetupMapping()
{
}

void CBuildingElectricTower_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingElectricTower_lod2Factory
CBuildingElectricTower_lod2Factory::CBuildingElectricTower_lod2Factory()
{
	BuildingType = "ELECTRICTOWER_LOD2";
}
...
Core::CBuilding* CBuildingElectricTower_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingElectricTower_lod2(Name, PhysicsStrategy);
}
