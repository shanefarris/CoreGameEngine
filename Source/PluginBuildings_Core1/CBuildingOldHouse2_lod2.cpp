...
CBuildingOldHouse2_lod2::CBuildingOldHouse2_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse2_lod2.mesh";
...
CBuildingOldHouse2_lod2::~CBuildingOldHouse2_lod2()
{
}

void CBuildingOldHouse2_lod2::SetupMapping()
{
}

void CBuildingOldHouse2_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse2_lod2Factory
CBuildingOldHouse2_lod2Factory::CBuildingOldHouse2_lod2Factory()
{
	BuildingType = "OLDHOUSE2_LOD2";
}
...
Core::CBuilding* CBuildingOldHouse2_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse2_lod2(Name, PhysicsStrategy);
}
