...
CBuildingHall1::CBuildingHall1(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "Hall1.mesh";
...
CBuildingHall1::~CBuildingHall1()
{
}

void CBuildingHall1::SetupMapping()
{
}

void CBuildingHall1::Update(const f32& elapsedTime)
{
}

// CBuildingHall1Factory
CBuildingHall1Factory::CBuildingHall1Factory()
{
	BuildingType = "HALL1";
}
...
Core::CBuilding* CBuildingHall1Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingHall1(Name, PhysicsStrategy);
}
