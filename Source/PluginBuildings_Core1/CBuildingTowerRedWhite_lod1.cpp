...
CBuildingTowerRedWhite_lod1::CBuildingTowerRedWhite_lod1(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "TowerRedWhite_lod1.mesh";
	...
	m_BuildingType = "TOWERREDWHITE_LOD1";
	// ===================================
...
CBuildingTowerRedWhite_lod1::~CBuildingTowerRedWhite_lod1()
{
}

void CBuildingTowerRedWhite_lod1::SetupMapping()
{
}

void CBuildingTowerRedWhite_lod1::Update(const f32& elapsedTime)
{
}

// CBuildingTowerRedWhite_lod1Factory
CBuildingTowerRedWhite_lod1Factory::CBuildingTowerRedWhite_lod1Factory()
{
	BuildingType = "TOWERREDWHITE_LOD1";
}
...
Core::CBuilding* CBuildingTowerRedWhite_lod1Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingTowerRedWhite_lod1(Name, PhysicsStrategy);
}
