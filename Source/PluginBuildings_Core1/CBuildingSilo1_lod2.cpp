...
CBuildingSilo1_lod2::CBuildingSilo1_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "Silo1_lod2.mesh";
...
CBuildingSilo1_lod2::~CBuildingSilo1_lod2()
{
}

void CBuildingSilo1_lod2::SetupMapping()
{
}

void CBuildingSilo1_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingSilo1_lod2Factory
CBuildingSilo1_lod2Factory::CBuildingSilo1_lod2Factory()
{
	BuildingType = "SILO1_LOD2";
}
...
Core::CBuilding* CBuildingSilo1_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingSilo1_lod2(Name, PhysicsStrategy);
}
