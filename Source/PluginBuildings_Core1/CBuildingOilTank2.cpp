...
CBuildingOilTank2::CBuildingOilTank2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OilTank2.mesh";
...
CBuildingOilTank2::~CBuildingOilTank2()
{
}

void CBuildingOilTank2::SetupMapping()
{
}

void CBuildingOilTank2::Update(const f32& elapsedTime)
{
}

// CBuildingOilTank2Factory
CBuildingOilTank2Factory::CBuildingOilTank2Factory()
{
	BuildingType = "OILTANK2";
}
...
Core::CBuilding* CBuildingOilTank2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOilTank2(Name, PhysicsStrategy);
}
