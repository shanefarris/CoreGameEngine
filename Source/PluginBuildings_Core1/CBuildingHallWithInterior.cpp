...
CBuildingHallWithInterior::CBuildingHallWithInterior(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "HallWithInterior.mesh";
	...
	m_BuildingType = "HALLWITHINTERIOR";
	// ===================================
...
CBuildingHallWithInterior::~CBuildingHallWithInterior()
{
}

void CBuildingHallWithInterior::SetupMapping()
{
}

void CBuildingHallWithInterior::Update(const f32& elapsedTime)
{
}

// CBuildingHallWithInteriorFactory
CBuildingHallWithInteriorFactory::CBuildingHallWithInteriorFactory()
{
	BuildingType = "HALLWITHINTERIOR";
}
...
Core::CBuilding* CBuildingHallWithInteriorFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingHallWithInterior(Name, PhysicsStrategy);
}
