...
CBuildingOpenedHall::CBuildingOpenedHall(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OpenedHall.mesh";
...
CBuildingOpenedHall::~CBuildingOpenedHall()
{
}

void CBuildingOpenedHall::SetupMapping()
{
}

void CBuildingOpenedHall::Update(const f32& elapsedTime)
{
}

// CBuildingOpenedHallFactory
CBuildingOpenedHallFactory::CBuildingOpenedHallFactory()
{
	BuildingType = "OPENEDHALL";
}
...
Core::CBuilding* CBuildingOpenedHallFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOpenedHall(Name, PhysicsStrategy);
}
