...
CBuildingElectricTower::CBuildingElectricTower(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "ElectricTower.mesh";
...
CBuildingElectricTower::~CBuildingElectricTower()
{
}

void CBuildingElectricTower::SetupMapping()
{
}

void CBuildingElectricTower::Update(const f32& elapsedTime)
{
}

// CBuildingElectricTowerFactory
CBuildingElectricTowerFactory::CBuildingElectricTowerFactory()
{
	BuildingType = "ELECTRICTOWER";
}
...
Core::CBuilding* CBuildingElectricTowerFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingElectricTower(Name, PhysicsStrategy);
}
