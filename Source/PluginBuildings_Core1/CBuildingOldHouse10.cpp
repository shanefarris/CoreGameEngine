...
CBuildingOldHouse10::CBuildingOldHouse10(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse10.mesh";
...
CBuildingOldHouse10::~CBuildingOldHouse10()
{
}

void CBuildingOldHouse10::SetupMapping()
{
}

void CBuildingOldHouse10::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse10Factory
CBuildingOldHouse10Factory::CBuildingOldHouse10Factory()
{
	BuildingType = "OLDHOUSE10";
}
...
Core::CBuilding* CBuildingOldHouse10Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse10(Name, PhysicsStrategy);
}
