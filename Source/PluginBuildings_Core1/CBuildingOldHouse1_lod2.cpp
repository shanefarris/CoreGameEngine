...
CBuildingOldHouse1_lod2::CBuildingOldHouse1_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse1_lod2.mesh";
...
CBuildingOldHouse1_lod2::~CBuildingOldHouse1_lod2()
{
}

void CBuildingOldHouse1_lod2::SetupMapping()
{
}

void CBuildingOldHouse1_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse1_lod2Factory
CBuildingOldHouse1_lod2Factory::CBuildingOldHouse1_lod2Factory()
{
	BuildingType = "OLDHOUSE1_LOD2";
}
...
Core::CBuilding* CBuildingOldHouse1_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse1_lod2(Name, PhysicsStrategy);
}
