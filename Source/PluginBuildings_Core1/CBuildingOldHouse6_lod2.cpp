...
CBuildingOldHouse6_lod2::CBuildingOldHouse6_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse6_lod2.mesh";
...
CBuildingOldHouse6_lod2::~CBuildingOldHouse6_lod2()
{
}

void CBuildingOldHouse6_lod2::SetupMapping()
{
}

void CBuildingOldHouse6_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse6_lod2Factory
CBuildingOldHouse6_lod2Factory::CBuildingOldHouse6_lod2Factory()
{
	BuildingType = "OLDHOUSE6_LOD2";
}
...
Core::CBuilding* CBuildingOldHouse6_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse6_lod2(Name, PhysicsStrategy);
}
