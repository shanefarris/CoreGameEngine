...
CBuildingHall3_lod2::CBuildingHall3_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "Hall3_lod2.mesh";
...
CBuildingHall3_lod2::~CBuildingHall3_lod2()
{
}

void CBuildingHall3_lod2::SetupMapping()
{
}

void CBuildingHall3_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingHall3_lod2Factory
CBuildingHall3_lod2Factory::CBuildingHall3_lod2Factory()
{
	BuildingType = "HALL3_LOD2";
}
...
Core::CBuilding* CBuildingHall3_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingHall3_lod2(Name, PhysicsStrategy);
}
