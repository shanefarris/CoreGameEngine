...
CBuildingOldHouse7_lod2::CBuildingOldHouse7_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse7_lod2.mesh";
...
CBuildingOldHouse7_lod2::~CBuildingOldHouse7_lod2()
{
}

void CBuildingOldHouse7_lod2::SetupMapping()
{
}

void CBuildingOldHouse7_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse7_lod2Factory
CBuildingOldHouse7_lod2Factory::CBuildingOldHouse7_lod2Factory()
{
	BuildingType = "OLDHOUSE7_LOD2";
}
...
Core::CBuilding* CBuildingOldHouse7_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse7_lod2(Name, PhysicsStrategy);
}
