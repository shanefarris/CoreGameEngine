...
CBuildingSilo1::CBuildingSilo1(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "Silo1.mesh";
...
CBuildingSilo1::~CBuildingSilo1()
{
}

void CBuildingSilo1::SetupMapping()
{
}

void CBuildingSilo1::Update(const f32& elapsedTime)
{
}

// CBuildingSilo1Factory
CBuildingSilo1Factory::CBuildingSilo1Factory()
{
	BuildingType = "SILO1";
}
...
Core::CBuilding* CBuildingSilo1Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingSilo1(Name, PhysicsStrategy);
}
