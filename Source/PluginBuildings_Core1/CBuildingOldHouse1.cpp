...
CBuildingOldHouse1::CBuildingOldHouse1(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse1.mesh";
...
CBuildingOldHouse1::~CBuildingOldHouse1()
{
}

void CBuildingOldHouse1::SetupMapping()
{
}

void CBuildingOldHouse1::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse1Factory
CBuildingOldHouse1Factory::CBuildingOldHouse1Factory()
{
	BuildingType = "OLDHOUSE1";
}
...
Core::CBuilding* CBuildingOldHouse1Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse1(Name, PhysicsStrategy);
}
