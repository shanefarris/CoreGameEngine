...
CBuildingTank1::CBuildingTank1(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "Tank1.mesh";
...
CBuildingTank1::~CBuildingTank1()
{
}

void CBuildingTank1::SetupMapping()
{
}

void CBuildingTank1::Update(const f32& elapsedTime)
{
}

// CBuildingTank1Factory
CBuildingTank1Factory::CBuildingTank1Factory()
{
	BuildingType = "TANK1";
}
...
Core::CBuilding* CBuildingTank1Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingTank1(Name, PhysicsStrategy);
}
