...
CBuildingTowerRedWhite::CBuildingTowerRedWhite(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "TowerRedWhite.mesh";
...
CBuildingTowerRedWhite::~CBuildingTowerRedWhite()
{
}

void CBuildingTowerRedWhite::SetupMapping()
{
}

void CBuildingTowerRedWhite::Update(const f32& elapsedTime)
{
}

// CBuildingTowerRedWhiteFactory
CBuildingTowerRedWhiteFactory::CBuildingTowerRedWhiteFactory()
{
	BuildingType = "TOWERREDWHITE";
}
...
Core::CBuilding* CBuildingTowerRedWhiteFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingTowerRedWhite(Name, PhysicsStrategy);
}
