...
CBuildingVillage_house2::CBuildingVillage_house2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "village_house2.mesh";
...
CBuildingVillage_house2::~CBuildingVillage_house2()
{
}

void CBuildingVillage_house2::SetupMapping()
{
}

void CBuildingVillage_house2::Update(const f32& elapsedTime)
{
}

// CBuildingVillage_house2Factory
CBuildingVillage_house2Factory::CBuildingVillage_house2Factory()
{
	BuildingType = "VILLAGE_HOUSE2";
}
...
Core::CBuilding* CBuildingVillage_house2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingVillage_house2(Name, PhysicsStrategy);
}
