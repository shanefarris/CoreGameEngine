...
CBuildingHall1_lod2::CBuildingHall1_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "Hall1_lod2.mesh";
...
CBuildingHall1_lod2::~CBuildingHall1_lod2()
{
}

void CBuildingHall1_lod2::SetupMapping()
{
}

void CBuildingHall1_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingHall1_lod2Factory
CBuildingHall1_lod2Factory::CBuildingHall1_lod2Factory()
{
	BuildingType = "HALL1_LOD2";
}
...
Core::CBuilding* CBuildingHall1_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingHall1_lod2(Name, PhysicsStrategy);
}
