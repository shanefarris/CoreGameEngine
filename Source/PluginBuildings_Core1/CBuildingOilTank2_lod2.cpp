...
CBuildingOilTank2_lod2::CBuildingOilTank2_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OilTank2_lod2.mesh";
...
CBuildingOilTank2_lod2::~CBuildingOilTank2_lod2()
{
}

void CBuildingOilTank2_lod2::SetupMapping()
{
}

void CBuildingOilTank2_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingOilTank2_lod2Factory
CBuildingOilTank2_lod2Factory::CBuildingOilTank2_lod2Factory()
{
	BuildingType = "OILTANK2_LOD2";
}
...
Core::CBuilding* CBuildingOilTank2_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOilTank2_lod2(Name, PhysicsStrategy);
}
