...
CBuildingBigOilTanker::CBuildingBigOilTanker(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "BigOilTanker.mesh";
...
CBuildingBigOilTanker::~CBuildingBigOilTanker()
{
}

void CBuildingBigOilTanker::SetupMapping()
{
}

void CBuildingBigOilTanker::Update(const f32& elapsedTime)
{
}

// CBuildingBigOilTankerFactory
CBuildingBigOilTankerFactory::CBuildingBigOilTankerFactory()
{
	BuildingType = "BIGOILTANKER";
}
...
Core::CBuilding* CBuildingBigOilTankerFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingBigOilTanker(Name, PhysicsStrategy);
}
