...
CBuildingOldHouse2::CBuildingOldHouse2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse2.mesh";
...
CBuildingOldHouse2::~CBuildingOldHouse2()
{
}

void CBuildingOldHouse2::SetupMapping()
{
}

void CBuildingOldHouse2::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse2Factory
CBuildingOldHouse2Factory::CBuildingOldHouse2Factory()
{
	BuildingType = "OLDHOUSE2";
}
...
Core::CBuilding* CBuildingOldHouse2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse2(Name, PhysicsStrategy);
}
