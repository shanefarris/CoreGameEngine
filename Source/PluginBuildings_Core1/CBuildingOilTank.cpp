...
CBuildingOilTank::CBuildingOilTank(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OilTank.mesh";
...
CBuildingOilTank::~CBuildingOilTank()
{
}

void CBuildingOilTank::SetupMapping()
{
}

void CBuildingOilTank::Update(const f32& elapsedTime)
{
}

// CBuildingOilTankFactory
CBuildingOilTankFactory::CBuildingOilTankFactory()
{
	BuildingType = "OILTANK";
}
...
Core::CBuilding* CBuildingOilTankFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOilTank(Name, PhysicsStrategy);
}
