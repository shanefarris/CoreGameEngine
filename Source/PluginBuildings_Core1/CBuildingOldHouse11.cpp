...
CBuildingOldHouse11::CBuildingOldHouse11(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse11.mesh";
...
CBuildingOldHouse11::~CBuildingOldHouse11()
{
}

void CBuildingOldHouse11::SetupMapping()
{
}

void CBuildingOldHouse11::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse11Factory
CBuildingOldHouse11Factory::CBuildingOldHouse11Factory()
{
	BuildingType = "OLDHOUSE11";
}
...
Core::CBuilding* CBuildingOldHouse11Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse11(Name, PhysicsStrategy);
}
