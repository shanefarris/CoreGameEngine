...
CBuildingOldHouse9::CBuildingOldHouse9(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse9.mesh";
...
CBuildingOldHouse9::~CBuildingOldHouse9()
{
}

void CBuildingOldHouse9::SetupMapping()
{
}

void CBuildingOldHouse9::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse9Factory
CBuildingOldHouse9Factory::CBuildingOldHouse9Factory()
{
	BuildingType = "OLDHOUSE9";
}
...
Core::CBuilding* CBuildingOldHouse9Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse9(Name, PhysicsStrategy);
}
