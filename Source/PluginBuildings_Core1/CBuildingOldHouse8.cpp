...
CBuildingOldHouse8::CBuildingOldHouse8(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse8.mesh";
...
CBuildingOldHouse8::~CBuildingOldHouse8()
{
}

void CBuildingOldHouse8::SetupMapping()
{
}

void CBuildingOldHouse8::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse8Factory
CBuildingOldHouse8Factory::CBuildingOldHouse8Factory()
{
	BuildingType = "OLDHOUSE8";
}
...
Core::CBuilding* CBuildingOldHouse8Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse8(Name, PhysicsStrategy);
}
