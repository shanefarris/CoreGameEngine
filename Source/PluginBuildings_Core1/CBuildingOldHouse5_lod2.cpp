...
CBuildingOldHouse5_lod2::CBuildingOldHouse5_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse5_lod2.mesh";
...
CBuildingOldHouse5_lod2::~CBuildingOldHouse5_lod2()
{
}

void CBuildingOldHouse5_lod2::SetupMapping()
{
}

void CBuildingOldHouse5_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse5_lod2Factory
CBuildingOldHouse5_lod2Factory::CBuildingOldHouse5_lod2Factory()
{
	BuildingType = "OLDHOUSE5_LOD2";
}
...
Core::CBuilding* CBuildingOldHouse5_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse5_lod2(Name, PhysicsStrategy);
}
