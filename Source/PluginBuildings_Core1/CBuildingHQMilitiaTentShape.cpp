...
CBuildingHQMilitiaTentShape::CBuildingHQMilitiaTentShape(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "HQMilitiaTentShape.mesh";
	...
	m_BuildingType = "HQMILITIATENTSHAPE";
	// ===================================
...
CBuildingHQMilitiaTentShape::~CBuildingHQMilitiaTentShape()
{
}

void CBuildingHQMilitiaTentShape::SetupMapping()
{
}

void CBuildingHQMilitiaTentShape::Update(const f32& elapsedTime)
{
}

// CBuildingHQMilitiaTentShapeFactory
CBuildingHQMilitiaTentShapeFactory::CBuildingHQMilitiaTentShapeFactory()
{
	BuildingType = "HQMILITIATENTSHAPE";
}
...
Core::CBuilding* CBuildingHQMilitiaTentShapeFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingHQMilitiaTentShape(Name, PhysicsStrategy);
}
