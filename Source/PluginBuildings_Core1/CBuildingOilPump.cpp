...
CBuildingOilPump::CBuildingOilPump(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OilPump.mesh";
...
CBuildingOilPump::~CBuildingOilPump()
{
}

void CBuildingOilPump::SetupMapping()
{
}

void CBuildingOilPump::Update(const f32& elapsedTime)
{
}

// CBuildingOilPumpFactory
CBuildingOilPumpFactory::CBuildingOilPumpFactory()
{
	BuildingType = "OILPUMP";
}
...
Core::CBuilding* CBuildingOilPumpFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOilPump(Name, PhysicsStrategy);
}
