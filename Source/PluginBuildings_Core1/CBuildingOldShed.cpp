...
CBuildingOldShed::CBuildingOldShed(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldShed.mesh";
...
CBuildingOldShed::~CBuildingOldShed()
{
}

void CBuildingOldShed::SetupMapping()
{
}

void CBuildingOldShed::Update(const f32& elapsedTime)
{
}

// CBuildingOldShedFactory
CBuildingOldShedFactory::CBuildingOldShedFactory()
{
	BuildingType = "OLDSHED";
}
...
Core::CBuilding* CBuildingOldShedFactory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldShed(Name, PhysicsStrategy);
}
