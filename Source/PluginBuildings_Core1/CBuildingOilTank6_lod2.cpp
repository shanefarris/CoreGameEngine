...
CBuildingOilTank6_lod2::CBuildingOilTank6_lod2(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OilTank6_lod2.mesh";
...
CBuildingOilTank6_lod2::~CBuildingOilTank6_lod2()
{
}

void CBuildingOilTank6_lod2::SetupMapping()
{
}

void CBuildingOilTank6_lod2::Update(const f32& elapsedTime)
{
}

// CBuildingOilTank6_lod2Factory
CBuildingOilTank6_lod2Factory::CBuildingOilTank6_lod2Factory()
{
	BuildingType = "OILTANK6_LOD2";
}
...
Core::CBuilding* CBuildingOilTank6_lod2Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOilTank6_lod2(Name, PhysicsStrategy);
}
