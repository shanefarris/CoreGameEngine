...
CBuildingOldHouse5::CBuildingOldHouse5(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) : CBuilding(Name, PhysicsStrategy)
{
	m_MeshName = "OldHouse5.mesh";
...
CBuildingOldHouse5::~CBuildingOldHouse5()
{
}

void CBuildingOldHouse5::SetupMapping()
{
}

void CBuildingOldHouse5::Update(const f32& elapsedTime)
{
}

// CBuildingOldHouse5Factory
CBuildingOldHouse5Factory::CBuildingOldHouse5Factory()
{
	BuildingType = "OLDHOUSE5";
}
...
Core::CBuilding* CBuildingOldHouse5Factory::CreateBuilding(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy)
{
	return new CBuildingOldHouse5(Name, PhysicsStrategy);
}
