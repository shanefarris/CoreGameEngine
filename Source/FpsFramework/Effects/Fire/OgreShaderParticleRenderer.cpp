...
namespace Ogre 
{
	...
	//////////////////////////////////////////////////////////////////////////
	void ShaderParticleRenderer::_updateRenderQueue(RenderQueue* queue, list<Particle*>::type& currentParticles, bool cullIndividually)
	{
	...
	unsigned short ShaderParticleRenderer::getNumWorldTransforms(void) const
	{
		if(mKeepInLocalSpace && mParentNode != NULL) {
			return 1; //return mParentNode->getNumWorldTransforms();
		} else {
			return 1;
		}
	}
