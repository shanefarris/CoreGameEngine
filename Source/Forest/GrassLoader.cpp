...
void GrassLayer::setDensityMap(const String &mapFile)
{
	setDensityMap(mapFile, CHANNEL_COLOR);
}
...
void GrassLayer::setDensityMap(TexturePtr map)
{
	setDensityMap(map, CHANNEL_COLOR);
}
...
void GrassLayer::setColorMap(const String &mapFile)
{
	setColorMap(mapFile, CHANNEL_COLOR);
}
...
void GrassLayer::setColorMap(TexturePtr map)
{
	setColorMap(map, CHANNEL_COLOR);
}
