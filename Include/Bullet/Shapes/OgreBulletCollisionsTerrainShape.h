...
//{
//	
//	class CORE_EXPORT DebugHelper : public btIDebugDraw
//	{
//	public:
//
//		DebugHelper(DebugLines* pLines) : m_pLines(pLines) {}
...
//			Ogre::Real heightScale = maxHeight / 256;
//
//			btHeightfieldTerrainShape* terrainShape = 
//				new btHeightfieldTerrainShape(width, width, pHeightData, heightScale, minHeight, maxHeight, upAxis, PHY_UCHAR, flipQuadEdges);
//
//			//btHeightfieldTerrainShape* pHeightShape = 
//			//	new btHeightfieldTerrainShape(width, length, pHeightData, scale.y, upIndex, useFloatDatam, flipQuadEdges);
//			//pHeightShape->setUseDiamondSubdivision(true);
//			
//			terrainShape->setLocalScaling(OgreBulletCollisions::OgreBtConverter::to(localScale));
...
//		Vector3 GetMinAaBb()
//		{
//			return OgreBulletCollisions::BtOgreConverter::to(min);
//		}
//
//		virtual ~HeightmapCollisionShape()
//		{
