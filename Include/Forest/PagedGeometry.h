...
class CORE_EXPORT PagedGeometry
{
public:
	/**
	...
	*/
	PagedGeometry(Ogre::Camera *cam = nullptr, Ogre::Real pageSize = 100, Ogre::RenderQueueGroupID queue = Ogre::RENDER_QUEUE_6);
...
*/
class CORE_EXPORT GeometryPage
{
...
*/
class CORE_EXPORT GeometryPageManager
{
public:
