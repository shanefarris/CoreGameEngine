...
*/
class CORE_EXPORT TreeLoader2D: public PageLoader
{
public:
	...
	void addTree(Ogre::Entity *entity, const Ogre::Vector3 &position, Ogre::Degree yaw = Ogre::Degree(0), Ogre::Real scale = 1.0f, void* userData = nullptr);
	...
	*/
	void setHeightFunction(Ogre::Real (*heightFunction)(Ogre::Real x, Ogre::Real z, void *userData), void *userData = nullptr)
	{
...
class CORE_EXPORT TreeIterator2D
{
public:
